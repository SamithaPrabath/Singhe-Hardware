...
public class MonthlyCustomerReport extends javax.swing.JFrame {
   ...
   void showTableContent(){
        ...
        try{
            ...
            String query="select * from customers where month(date)=month(curdate());";
    ...
    private void monthActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_monthActionPerformed
        ...
        try{
            ...
            String query="select * from customers where month(date)="+m+";";
            ResultSet rs =st.executeQuery(query);
            while(rs.next()){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            ...
            //JasperReport jr= (JasperReport)JRLoader.loadObject(getClass().getResourceAsStream("/customer/SingheMonthlyCustomerReport.jasper"));
            JasperReport jr = JasperCompileManager.compileReport("C:\\Users\\Moditha punchihewa\\Documents\\NetBeansProjects\\Singhe\\src\\reports\\SingheMonthlyCustomerReport.jrxml");
            //JasperReport jr = JasperCompileManager.compileReport("D:/Educational/SLITT/Projects/Project/New Folder/Singhe Hardware/Singhe/src/customer/SingheMonthlyCustomerReport.jrxml");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/singhe_hardware_db","root","");
            Statement st=con.createStatement();
            String query="select date(date) as date,count(customer_id) as count from customers where month(date)="+m+" group by date(date);";
            ResultSet rs=st.executeQuery(query);
            while(rs.next()){
            ...
            JFreeChart chart = ChartFactory.createBarChart("Monthly Customer Report - "+month.getSelectedItem(), "Date","Count", dataset, PlotOrientation.VERTICAL,false,true,false);
