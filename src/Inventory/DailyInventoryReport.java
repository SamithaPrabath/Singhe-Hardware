...
public class DailyInventoryReport extends javax.swing.JFrame {


    public DailyInventoryReport() {
        initComponents();
        showTableContent();
    }
    void showTableContent(){
        DefaultTableModel dt =(DefaultTableModel)dailyProduct.getModel();
        ...
        try{
            ...
            String query="select pname,sum(quantity) as quantity,date from sellProducts where date=curdate() group by pname;";
    ...
    private void initComponents() {
        ...
        dailyProduct = new javax.swing.JTable();
        ...
        jLabel1.setText("Daily Inventory Report");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, -1, -1));

        dailyProduct.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Product Id", "Product Name", " Supplier Id", "Sold", "Date"
            }
        ) {
        ...
        jScrollPane1.setViewportView(dailyProduct);
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 640, -1, -1));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 660, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            Statement st=con.createStatement();
            Statement st1=con.createStatement();
            String query="select pname,sum(quantity) as quantity,date from sellProducts where date='"+dat+"' group by pname;";
            ResultSet rs =st.executeQuery(query);
            while(rs.next()){
                p[1]=rs.getString("pname");
                p[3]=rs.getString("quantity");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            ...
            hm.put("date", dat);
            //JasperReport jr= (JasperReport)JRLoader.loadObject(getClass().getResourceAsStream("/Inventory/SingheDailyInventoryReport.jasper"));
            JasperReport jr = JasperCompileManager.compileReport("C:\\Users\\Moditha punchihewa\\Documents\\NetBeansProjects\\Singhe\\src\\reports\\SingheDailyInventoryReport.jrxml");
    ...
    private javax.swing.JTable dailyProduct;
