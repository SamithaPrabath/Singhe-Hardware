...
public class MonthlySupplierReport extends javax.swing.JFrame {

 
    public MonthlySupplierReport() {
        initComponents();
        showTableContent();
    }
    static int m=0;
   void showTableContent(){
        ...
        try{
            ...
            String query="select * from supplier where month(date)=month(curdate());";
            ResultSet rs =st.executeQuery(query);
            while(rs.next()){

                p[0]=rs.getString("supplier_id");
                p[1]=rs.getString("supplier_name");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Monthly Supplier Report");
        ...
        supplierTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Supplier Id", "Supplier Name", "Phone No", "Address", "Date"
            }
        ) {
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 640, -1, -1));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 650, -1, -1));

        jButton6.setBackground(new java.awt.Color(0, 153, 153));
        jButton6.setText("Genarate Chart");
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 650, -1, -1));
    ...
    private void monthActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_monthActionPerformed
        ...
        try{
            ...
            String query="select * from supplier where month(date)="+m+";";
            ResultSet rs =st.executeQuery(query);
            while(rs.next()){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            ...
            //JasperReport jr= (JasperReport)JRLoader.loadObject(getClass().getResourceAsStream("/supplier/SingheMonthlySupplierReport.jasper"));
            JasperReport jr = JasperCompileManager.compileReport("C:\\Users\\Moditha punchihewa\\Documents\\NetBeansProjects\\Singhe\\src\\reports\\SingheMonthlySupplierReport.jrxml"); 
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/singhe_hardware_db","root","");
            Statement st=con.createStatement();
            String query="select date(date) as date,count(supplier_id) as count from supplier where month(date)="+m+" group by date(date);";
            ResultSet rs=st.executeQuery(query);
            while(rs.next()){
                String d=rs.getString("date");
                double count=Double.valueOf((rs.getString("count")));
                dataset.setValue(count, "Count", d);
            }
            JFreeChart chart = ChartFactory.createBarChart("Monthly Supplier Report - "+month.getSelectedItem(), "Date","Count", dataset, PlotOrientation.VERTICAL,false,true,false);
