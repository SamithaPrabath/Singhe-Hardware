...
public class DailySupplierReport extends javax.swing.JFrame {

  
    public DailySupplierReport() {
        initComponents();
        showTableContent();
    }
    ...
    void showTableContent(){
        ...
        try{
            ...
            String query="select * from supplier where date(date)=curdate();";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Daily Supplier Report");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{    
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/singhe_hardware_db","root","");
            Statement st=con.createStatement();
            String query="select * from supplier where date(date)='"+dat+"';";
            ResultSet rs =st.executeQuery(query);
            while(rs.next()){
                p[0]=rs.getString("supplier_id");
                p[1]=rs.getString("supplier_name");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            ...
            hm.put("date", dat);
           // JasperReport jr= (JasperReport)JRLoader.loadObject(getClass().getResourceAsStream("/supplier/SingheDailySuplierReport.jasper"));
           JasperReport jr = JasperCompileManager.compileReport("C:\\Users\\Moditha punchihewa\\Documents\\NetBeansProjects\\Singhe\\src\\reports\\SingheDailySuplierReport.jrxml"); 
