...
public class SupplierCard extends javax.swing.JFrame {
    ...
    public SupplierCard() {
        ...
        try {
            ...
            String query="select * from supplier order by date desc limit 1;";
    ...
    private void initComponents() {
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 280, -1, -1));
