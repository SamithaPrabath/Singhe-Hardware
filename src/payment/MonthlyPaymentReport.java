...
public class MonthlyPaymentReport extends javax.swing.JFrame {
    ...
    public void showTableContent(){
        double amount=0.00;
        DefaultTableModel dt =(DefaultTableModel)monthlyPayment.getModel();
        String p[]=new String[4];
        try{
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/singhe_hardware_db","root","");
            Statement st=con.createStatement();
            String query="select * from payment where month(date)=month(curdate());";
    ...
    private void initComponents() {
        ...
        monthlyPayment = new javax.swing.JTable();
        ...
        monthlyPayment.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(monthlyPayment);
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 670, 80, 20));

        total.setEditable(false);
        jPanel1.add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 670, 170, -1));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 670, -1, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 660, -1, -1));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 660, -1, -1));
    ...
    private void monthActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_monthActionPerformed
        ...
        try{
            ...
            String query="select * from payment where month(date)="+m+";";
            ResultSet rs =st.executeQuery(query);
            while(rs.next()){
                p[0]=rs.getString("payment_id");
                p[1]=rs.getString("cname");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       try{
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/singhe_hardware_db","root","");
            Statement st=con.createStatement();
            String query="select date(date) as date,sum(ammount) as am from payment where month(date)="+m+" group by date(date);";
            ResultSet rs =st.executeQuery(query);
            while(rs.next()){
                String date=rs.getString("date");
                double amount=Double.valueOf(rs.getString("am"));
                dataset.setValue(amount, "Payment", date);
            }
        }
        catch(Exception ex){
        ...
        JFreeChart chart = ChartFactory.createBarChart("Monthly Payment - "+month.getSelectedItem(), "Date","Payment", dataset, PlotOrientation.VERTICAL,false,true,false);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            ...
            //JasperReport jr= (JasperReport)JRLoader.loadObject(getClass().getResourceAsStream("/payment/SingheMonthlyPaymentReport.jasper"));
            JasperReport jr = JasperCompileManager.compileReport("C:\\Users\\Moditha punchihewa\\Documents\\NetBeansProjects\\Singhe\\src\\reports\\SingheMonthlyPaymentReport.jrxml");
    ...
    private javax.swing.JTable monthlyPayment;
